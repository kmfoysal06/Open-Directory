		...
		<form method="POST">
			...
			<div class="field-container">
			    ...
			    <select name="opendirectory[insert_rule]" id="insert-rule" title="Who Can Add Directory Item?">
			    	<option value="unknown" <?php echo opendirectory_compare_select($opendirectory_insert_rules, 'unknown'); ?>>Everyone (Even Without Their Name)</option>
			...
			<div class="field-container">
			    ...
			    <select name="opendirectory[privacy]" id="privacy" title="Who Can Vist The Directory?">
			    	<option value="everyone" <?php echo opendirectory_compare_select($opendirectory_privacy, 'everyone'); ?>>Everyone</option>
			    	<option value="user" <?php echo opendirectory_compare_select($opendirectory_privacy, 'user'); ?>>Only Users</option>
			    	<option value="admin" <?php echo opendirectory_compare_select($opendirectory_privacy, 'admin'); ?>>Only Admin</option>
			    	<option value="private" <?php echo opendirectory_compare_select($opendirectory_privacy, 'private'); ?>>Private</option>
			    </select>
			</div>
